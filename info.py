...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7798556356:AAHX_WBMP4jklFKgSuFYPhJyU6KZv6IROOw')
if len(BOT_TOKEN) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002452479026')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002476741366')
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "mongodb+srv://irlwolf:9aEpUre0fkmBjHVz@cluster0.jkd3o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002409821863")
if len(BIN_CHANNEL) == 0:
    logger.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/serieswolf")
if len(URL) == 0:
